...
struct BlueCursorView: View {
    ...
    private let fullWelcomeMessage = "hey, i'm annie"
    ...
    var body: some View {
        ZStack {
            ...
            Triangle()
                ...
                .shadow(
                    color: DS.Colors.overlayCursorBlue.opacity(0.9),
                    radius: 8 + (buddyFlightScale - 1.0) * 20,
                    x: 0,
                    y: 0
                )
            ...
            // Blue spinner — shown while the AI is processing (transcription + chat response + waiting for TTS)
        ...
        .onAppear {
            ...
            if isFirstAppearance && isCursorOnThisScreen {
                ...
                companionManager.playInitialIntroductionIfNeeded()
