...
struct CompanionPanelView: View {
    ...
    private var permissionsCopySection: some View {
        if companionManager.hasCompletedOnboarding && companionManager.allPermissionsGranted {
            ...
            Text("You're all set. Hit Start to meet Annie.")
                .font(.system(size: 12, weight: .medium))
                .foregroundColor(DS.Colors.textSecondary)
                .frame(maxWidth: .infinity, alignment: .leading)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Some permissions were revoked. Grant all four below to keep using Annie.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text("Hi, I'm Akash. This is Annie.")
                    .font(.system(size: 12, weight: .bold))
                    .foregroundColor(DS.Colors.textSecondary)
                ...
                Text("Nothing runs in the background. Annie will only take a screenshot when you press the hot key. So, you can give that permission in peace. If you are still sus, eh, I can't do much there champ.")
                    .font(.system(size: 11))
